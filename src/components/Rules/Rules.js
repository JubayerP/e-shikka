...
const Rules = () => {
    return (
        <div className='my-28 grid lg:grid-cols-4 sm:grid-cols-1 w-[90vw] mx-auto'>
            <div className='relative bottom-[-3rem] lg:mb-0 mb-28'>
                ...
                <p className='text-center lg:w-full w-[13rem] lg:ml-0 mx-auto'>Start a Show Academy Course of Your Choice For Free</p>
            </div>
